...
export const VCardPreview = ({ vcard, showActions = true, className }) => {
  ...
  return (
    <div 
      className={cn("bg-white shadow-xl border-t-4 border-amber-600 overflow-hidden max-w-md mx-auto", className)}
    ...
    >
      ...
      <div className="bg-slate-900 p-6 text-center">
        {vcard.photo_url ? (
          ...
          <div className="w-24 h-24 rounded-full mx-auto mb-4 bg-slate-700 flex items-center justify-center border-4 border-white">
        ...
        {vcard.job_title && (
          <p className="text-slate-300 mt-1">{vcard.job_title}</p>
        )}
        {vcard.company && (
          <p className="text-amber-500 font-medium mt-1">{vcard.company}</p>
        )}
      </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <a href={`tel:${vcard.phone}`} className="text-slate-900 font-medium hover:text-amber-600">
              {vcard.phone || '-'}
            </a>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <a href={`mailto:${vcard.email}`} className="text-slate-900 font-medium hover:text-amber-600">
              {vcard.email || '-'}
            </a>
          </div>
        </div>
        ...
        {vcard.company && (
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-900 font-medium">{vcard.company}</p>
            </div>
          </div>
        )}
        ...
        {(social.website || social.linkedin || social.twitter || social.facebook || social.instagram) && (
          <div className="pt-4 border-t border-slate-200">
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-3">Redes Sociales</p>
